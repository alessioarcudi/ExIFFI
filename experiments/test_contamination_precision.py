...
precisions = contamination_in_training_precision_evaluation(I, dataset, n_runs, contamination)
...
plot_precision_over_contamination(precisions,  I.name, path_plots, plot_image=False)
